SKRT Core version 2.3.1 is now available from:

  <https://github.com/sikretcoin/skrt/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/sikretcoin/skrt/issues>

How to Upgrade
==============

If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/SKRT-Qt (on Mac) or skrtd/skrt-qt (on Linux).

Compatibility
==============

SKRT Core is extensively tested on multiple operating systems using
...
SKRT Core should also work on most other Unix-like systems but is not
...
Examples:
> skrt-cli startmasternode "alias" true "my_mn"
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "startmasternode", "params": ["alias" true "my_mn"] }' -H 'content-type: text/plain;' http://127.0.0.1:10138/
```
...
Examples:
> skrt-cli mnbudgetvote "local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "mnbudgetvote", "params": ["local" "ed2f83cedee59a91406f5f47ec4d60bf5a7f9ee6293913c82976bd2d3a658041" "yes"] }' -H 'content-type: text/plain;' http://127.0.0.1:10138/
```
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) SKRT address of payment
...
Examples:
> skrt-cli getbudgetinfo
> curl --user myusername --data-binary '{"jsonrpc": "1.0", "id":"curltest", "method": "getbudgetinfo", "params": [] }' -H 'content-type: text/plain;' http://127.0.0.1:10138/
```
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/skrt-project-translations/).
