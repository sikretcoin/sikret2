...
CAmount AmountFromValue(const Value& value)
{
    ...
    {
        std::string str = value.get_str();
        str.erase(std::remove(str.begin(), str.end(), '\"'), str.end());
        double dAmount = std::stod(str);
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SikretCoin features */
        {"skrt", "masternode", &masternode, true, true, false},
        {"skrt", "masternodelist", &masternodelist, true, true, false},
        {"skrt", "mnbudget", &mnbudget, true, true, false},
        {"skrt", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"skrt", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"skrt", "mnsync", &mnsync, true, true, false},
        {"skrt", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"skrt", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use skrtd, or the -server option to skrt-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> skrt-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10138/\n";
}
